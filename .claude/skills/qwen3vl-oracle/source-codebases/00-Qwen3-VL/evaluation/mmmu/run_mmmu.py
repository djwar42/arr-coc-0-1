"""Qwen3-VL MMMU Evaluation - Multi-Discipline Multimodal Understanding Benchmark"""

# <claudes_code_comments>
# ** Function List **
# run_inference: Main inference loop for MMMU dataset
# main: Parse arguments and run evaluation
#
# ** Technical Review **
# MMMU (Massive Multi-discipline Multimodal Understanding) evaluation script for Qwen3-VL.
# Tests model's ability to understand and reason across diverse academic domains.
#
# MMMU BENCHMARK:
# - 11K college-level questions across 30 subjects (art, biology, business, chemistry, etc.)
# - Multimodal: Questions include images, diagrams, tables, charts
# - Multiple choice (A/B/C/D) and free-form answer questions
# - Tests: perception, knowledge recall, reasoning, calculation
#
# EVALUATION PIPELINE:
# 1. Load dataset: MMMU validation or test split
# 2. Dump images: Save images to disk for model input
# 3. Preprocess: Convert MMMU format to model format
# 4. Inference: Run model on each question
# 5. Judge: Evaluate answer correctness
# 6. Aggregate: Calculate accuracy per subject and overall
#
# MODEL INTEGRATION:
# - Uses Qwen2VLChat wrapper (compatible with Qwen2/2.5/3-VL)
# - process_vision_info: Handles dynamic resolution image preprocessing
# - Supports Chain-of-Thought (CoT) prompting via --use-cot flag
#
# COT PROMPTING:
# - Adds reasoning instructions to system prompt
# - Example: "Think step by step based on difficulty..."
# - Improves accuracy on complex reasoning questions
# - Trade-off: Slower inference, more tokens
#
# ANSWER JUDGING:
# - Multiple choice: Exact match on A/B/C/D
# - Free-form: Uses build_judge for fuzzy matching
# - Handles edge cases: multiple correct formats, typos
#
# OUTPUT FORMAT:
# - JSON file with results per sample:
#   {
#     "id": "...",
#     "question": "...",
#     "options": {...},
...
# TYPICAL USAGE:
# python run_mmmu.py \
#   --model-path Qwen/Qwen3-VL-7B-Instruct \
#   --dataset mmmu_validation \
