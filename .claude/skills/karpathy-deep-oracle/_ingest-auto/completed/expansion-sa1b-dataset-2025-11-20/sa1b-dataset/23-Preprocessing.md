...
**SA-1B: torchvision transforms for image-mask synchronized augmentation.**

---

## Key Points

1. **Overview:** torchvision transforms for image-mask synchronized augmentation.
...
**Using Preprocessing for spatial relevance realization:**
