...
**SA-1B: Stratified sampling by mask granularity for balanced training.**

---

## Key Points

1. **Overview:** Stratified sampling by mask granularity for balanced training.
...
```python
# Example implementation for Batch Sampling
import torch
...
**Using Batch Sampling for spatial relevance realization:**
