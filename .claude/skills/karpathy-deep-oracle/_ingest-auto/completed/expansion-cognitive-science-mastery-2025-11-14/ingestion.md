...
- ✅ **4 runners**: Safest (quality + manageable)
- ✅ **6 runners**: Good for MONSTER expansions (quality + speed)
- ⚠️ **8+ runners**: Not recommended (too much to review)
...
## 📋 THE 16 INFLUENTIAL FILES (Explicit Reference in EVERY PART)
...
## ⚠️ EXECUTION PLAN: 7 BATCHES OF 6 RUNNERS
...
- [✓] PART 1: Create cognitive-mastery/00-free-energy-principle-foundations.md (Completed 2025-11-16 18:00)
...
- [✓] PART 2: Create cognitive-mastery/01-precision-attention-resource.md (Completed 2025-11-16 19:17)

**Step 0: Check Existing Knowledge**
- [✓] Read cognitive-foundations/03-attention-resource-allocation.md (existing attention knowledge)
- [✓] Read cognitive-foundations/00-active-inference-free-energy.md (precision-weighted errors)

**Influenced by**: Files 2,6,10 (pipeline parallel, VLM serving, Kubeflow) + ARR-COC (10%)

**Step 1: Web Research**
- [✓] Search: "precision-weighted prediction errors 2024"
- [✓] Search: "attention as gain control neuroscience"
- [✓] Search: "expected precision active inference"
- [✓] Search: "resource-rational analysis attention"
...
- [✓] **CITE**: Files 2,6,10 explicitly + 20+ precision papers + arr-coc implementation

**Step 3: Create KNOWLEDGE DROP**
- [✓] Create KNOWLEDGE-DROP-precision-attention-2025-11-16-1917.md

---

## PART 3: Salience & Relevance Realization (~700 lines)

- [✓] PART 3: Create cognitive-mastery/02-salience-relevance-realization.md (Completed 2025-11-16 17:51)
...
- [✓] PART 4: Create cognitive-mastery/03-affordances-4e-cognition.md (Completed 2025-11-16 19:13)
...
- [✓] PART 5: Create cognitive-mastery/04-hierarchical-predictive-processing.md (Completed 2025-11-16 19:25)
...
- [ ] Section 3: Bayesian brain (posterior updating, likelihood × prior)
- [ ] Section 4: Vision hierarchies (V1 edges → V2 contours → V4 objects → IT concepts)
...
- [✓] PART 6: Create cognitive-mastery/05-cybernetics-control-theory.md (Completed 2025-11-16 19:25)
...
- [ ] Section 8: **ARR-COC-0-1**: Relevance feedback loops (allocate → measure → adjust) (10%)
...
- [✓] PART 7: Create cognitive-mastery/06-bayesian-inference-deep.md (Completed 2025-11-16 19:24)
...
- [✓] PART 8: Create cognitive-mastery/07-predictive-coding-algorithms.md (Completed 2025-11-16 19:25)
...
- [✓] PART 9: Create cognitive-mastery/08-variational-inference-active.md (Completed 2025-11-16 19:33)
...
- [✓] PART 11: Create cognitive-mastery/10-uncertainty-confidence.md (Completed 2025-11-16 19:32)
...
- [✓] PART 12: Create cognitive-mastery/11-prior-knowledge-learning.md (Completed 2025-11-16 19:29)
...
- [✓] PART 13: Create cognitive-mastery/12-shannon-entropy-information.md (Completed 2025-11-16 19:50)
...
- [✓] PART 14: Create cognitive-mastery/13-mutual-information-correlation.md (Completed 2025-11-16 19:50)
...
- [✓] PART 15: Create cognitive-mastery/14-rate-distortion-theory.md (Completed 2025-11-16 19:49)
...
- [✓] PART 16: Create cognitive-mastery/15-kl-divergence-relative-entropy.md (Completed 2025-11-16 19:49)
...
- [✓] PART 17: Create cognitive-mastery/16-channel-capacity-noisy.md (Completed 2025-11-16 20:16)
...
- [✓] PART 18: Create cognitive-mastery/17-information-bottleneck-compression.md (Completed 2025-11-16 20:17)
...
- [✓] PART 19: Create cognitive-mastery/18-multi-armed-bandits.md (Completed 2025-11-16 20:17)

**Influenced by**: Files 3,11,15 (tensor parallel, Ray, Intel) + ARR-COC (10%)

**Topics**: Exploration-exploitation tradeoff, ε-greedy, UCB, Thompson sampling, regret bounds, token allocation as MAB

---

## PART 20: Contextual Bandits & Personalization (~700 lines)

- [✓] PART 20: Create cognitive-mastery/19-contextual-bandits-personalization.md (Completed 2025-11-16 20:23)
...
- [✓] PART 21: Create cognitive-mastery/20-reinforcement-learning-reward.md (Completed 2025-11-16 21:14)
...
- [✓] PART 22: Create cognitive-mastery/21-planning-model-based-control.md (Completed 2025-11-16 21:14)
...
- [✓] PART 23: Create cognitive-mastery/22-resource-rational-decision.md (Completed 2025-11-16 21:14)
...
- [✓] PART 24: Create cognitive-mastery/23-exploration-bonuses-curiosity.md (Completed 2025-11-16 21:14)
...
- [✓] PART 25: Create cognitive-mastery/24-visual-attention-mechanisms.md (Completed 2025-11-16 21:22)
...
- [✓] PART 26: Create cognitive-mastery/25-saccades-eye-movements.md (Completed 2025-11-16 21:24)
...
- [✓] PART 27: Create cognitive-mastery/26-gestalt-perceptual-organization.md (Completed 2025-11-16 21:22)
...
- [✓] PART 28: Create cognitive-mastery/27-psychophysics-detection-theory.md (Completed 2025-11-16 21:23)
...
- [✓] PART 29: Create cognitive-mastery/28-change-inattentional-blindness.md (Completed 2025-11-16 21:42)
...
- [✓] PART 30: Create cognitive-mastery/29-foveated-vision-peripheral.md (Completed 2025-11-16 21:41)
...
- [✓] PART 31: Create cognitive-mastery/30-experimental-design-fundamentals.md (Completed 2025-11-16 21:42)
...
- [✓] PART 32: Create cognitive-mastery/31-ablation-studies-causal.md (Completed 2025-11-16 21:41)
...
- [✓] PART 33: Create cognitive-mastery/32-statistical-hypothesis-testing.md (Completed 2025-11-16 21:42)
...
- [✓] PART 34: Create cognitive-mastery/33-effect-sizes-practical.md (Completed 2025-11-16 21:15)
...
- [✓] PART 35: Create cognitive-mastery/34-bayesian-statistical-methods.md (Completed 2025-11-16 21:15)
...
- [✓] PART 37: Create cognitive-mastery/36-academic-writing-paper-structure.md (Completed 2025-11-16 21:14)
...
- [✓] PART 38: Create cognitive-mastery/37-scientific-argumentation-rhetoric.md (Completed 2025-11-16 21:16)
...
- [✓] PART 39: Create cognitive-mastery/38-data-visualization-best-practices.md (Completed 2025-11-16 21:15)
...
- [✓] PART 40: Create cognitive-mastery/39-meta-analysis-systematic-reviews.md (Completed 2025-11-16 21:14)
...
- [✓] PART 41: Create cognitive-mastery/40-reproducibility-open-science.md (Completed 2025-11-16 21:16)
...
- [✓] PART 42: Create cognitive-mastery/41-knowledge-synthesis-theoretical.md (Completed 2025-11-16 21:15)
...
**Coverage**: Active Inference → Bayesian Brain → Information Theory → Decision Making → Perception → Research Methods → Publication
**Influence**: ALL 16 files + ARR-COC-0-1 (10% in every file, Section 8)

**Ready to execute batch-by-batch! 🚀**
