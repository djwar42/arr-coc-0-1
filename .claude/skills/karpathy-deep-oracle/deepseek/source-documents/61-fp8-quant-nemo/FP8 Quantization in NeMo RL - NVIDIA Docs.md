---
sourceFile: "FP8 Quantization in NeMo RL - NVIDIA Docs"
exportedBy: "Kortex"
exportDate: "2025-10-29T02:37:34.686Z"
---

# FP8 Quantization in NeMo RL - NVIDIA Docs

f83d8cce-0638-4f93-8533-6ed77e919a91

FP8 Quantization in NeMo RL - NVIDIA Docs

bc20b453-4aeb-4854-bd34-66540434f05d
...
https://docs.nvidia.com#fp8-quantization-in-nemo-rl
...
https://docs.nvidia.com#supported-features

FP8 Generation

https://docs.nvidia.com#fp8-generation
...
https://docs.nvidia.com#fp8-training

## TransformerEngine

for linear layer implementation.

## Supports both

Deepseek-style sub-channel scaling

per-tensor scaling

## Integration with NeMo RL

https://docs.nvidia.com#integration-with-nemo-rl
...
https://docs.nvidia.com#raydistributedexecutor

For multi-GPU inference, the executor is patched to ensure that every worker process applies the same FP8 patches

before model initialization

## Quantization Utilities

https://docs.nvidia.com#quantization-utilities
