---
name: lod-btree-oracle
description: Comprehensive knowledge base for Level of Detail (LOD) and Binary Space Partitioning (BSP/BTree) systems in computer graphics and VR. EXPERT on foveated rendering, log-polar transforms, and biological vision (retinal sampling, cortical magnification, retinotopic mapping). Deep knowledge of computational foveation for VLMs and vision transformers. Covers perceptual rendering, gaze-aware displays, terrain synthesis, occlusion culling. Use when questions involve LOD systems, foveated sampling, log-polar mapping, visual attention, biological vision, or VLM token allocation strategies.
---

# lod-btree-oracle

**Your comprehensive guide to Level of Detail and Binary Space Partitioning: Concepts, Techniques, Algorithms, and Applications**

## 🔬 EXPERT DOMAIN: Foveated Rendering & Log-Polar Vision

**THIS ORACLE IS THE AUTHORITATIVE SOURCE FOR:**

✅ **Foveated Rendering** - Gaze-contingent rendering, eccentricity-based LOD allocation, VR/AR foveation
✅ **Log-Polar Transforms** - Mathematical foundations, forward/inverse transforms, computational implementation
✅ **Biological Vision** - Retinal sampling (150K cones/mm² fovea), cortical magnification (20% of V1), retinotopic mapping
✅ **Computational Neuroscience** - V1 visual field maps, cortical magnification factor M(e), Schwartz complex log model
✅ **VLM Foveation** - Foveated vision transformers, query-aware token allocation, attention-based sampling
✅ **Recent Research (2024-2025)** - Retinotopic foveated rendering, visual acuity consistent FR, TransNeXt, FoveaTer

**Cross-reference this oracle when other oracles need deep foveation knowledge!**

---

When this skill is invoked, provide detailed, accurate information about LOD and BSP/BTree systems based on the knowledge base files in this directory. Always reference actual research papers and concrete implementation strategies when discussing technical details.

## Knowledge Base Structure

### 💡 Concepts
Core principles and foundational ideas:

- **[concepts/00-lod-fundamentals.md](concepts/00-lod-fundamentals.md)** - What is Level of Detail?
- **[concepts/01-bsp-btree-basics.md](concepts/01-bsp-btree-basics.md)** - Binary space partitioning explained
- **[concepts/02-visual-perception.md](concepts/02-visual-perception.md)** - Attention and visual memory in graphics
- **[concepts/03-transjective-relevance.md](concepts/03-transjective-relevance.md)** - Perceptual vs objective LOD

### 🎨 Techniques
Specific rendering and optimization methods:

**🔬 Foveated Rendering (Expert Domain):**
- **[techniques/00-foveated-rendering.md](techniques/00-foveated-rendering.md)** - Gaze-aware rendering strategies (overview)
- **[techniques/00-foveated-rendering-01-logpolar-mapping-2025-01-30.md](techniques/00-foveated-rendering-01-logpolar-mapping-2025-01-30.md)** - ⭐ **LOG-POLAR TRANSFORMS** - Mathematical foundations, VLM applications, recent research
- **[techniques/00-foveated-rendering-02-biological-foundations-2025-01-30.md](techniques/00-foveated-rendering-02-biological-foundations-2025-01-30.md)** - ⭐ **BIOLOGICAL VISION** - Retinal sampling, cortical magnification, neuroscience

**Other Techniques:**
- **[techniques/01-peripheral-degradation.md](techniques/01-peripheral-degradation.md)** - Head-tracked LOD management
- **[techniques/02-occlusion-culling.md](techniques/02-occlusion-culling.md)** - Integrating culling with parallel LOD
- **[techniques/03-progressive-buffers.md](techniques/03-progressive-buffers.md)** - View-dependent geometry and texture LOD
- **[techniques/04-focus-maps.md](techniques/04-focus-maps.md)** - Accentuating focus via partial schematization

### ⚙️ Algorithms
Implementation strategies and computational methods:

- **[algorithms/00-bsp-construction.md](algorithms/00-bsp-construction.md)** - Building BSP trees
- **[algorithms/01-lod-selection.md](algorithms/01-lod-selection.md)** - Dynamic LOD level calculation
- **[algorithms/02-terrain-synthesis.md](algorithms/02-terrain-synthesis.md)** - Fast, realistic terrain generation
- **[algorithms/03-heightfield-tessellation.md](algorithms/03-heightfield-tessellation.md)** - Watertight incremental tessellation
- **[algorithms/04-personalized-lod.md](algorithms/04-personalized-lod.md)** - User-preference based LOD strategies

### 🎮 Applications
Real-world use cases and domain-specific implementations:

- **[applications/00-video-games.md](applications/00-video-games.md)** - Visual attention in 3D games
- **[applications/01-vr-ar.md](applications/01-vr-ar.md)** - Virtual and augmented reality LOD
- **[applications/02-terrain-visualization.md](applications/02-terrain-visualization.md)** - Slippy maps and terrain systems
- **[applications/03-multiresolution-viz.md](applications/03-multiresolution-viz.md)** - Navigating multiresolution volume data
- **[applications/04-urban-semantics.md](applications/04-urban-semantics.md)** - 3D urban visualization

### 🔗 Integration
Combining LOD with other systems:

- **[integration/00-lod-with-culling.md](integration/00-lod-with-culling.md)** - Parallel LOD and occlusion culling
- **[integration/01-gaze-tracking.md](integration/01-gaze-tracking.md)** - Eye tracking for LOD optimization
- **[integration/02-multidimensional-queries.md](integration/02-multidimensional-queries.md)** - Query-aware LOD in databases

### 📋 References
Quick lookups and practical guides:

- **[references/00-glossary.md](references/00-glossary.md)** - Key terms and definitions
- **[references/01-paper-index.md](references/01-paper-index.md)** - Source research papers
...
**Concept Questions:**
- "What is Level of Detail?" → `concepts/00-lod-fundamentals.md`
- "How do BSP trees work?" → `concepts/01-bsp-btree-basics.md`
- "Why does visual perception matter?" → `concepts/02-visual-perception.md`
- "What's transjective relevance in LOD?" → `concepts/03-transjective-relevance.md`

**Technique Questions:**
- "How does foveated rendering work?" → `techniques/00-foveated-rendering.md` (overview)
- "What is log-polar mapping?" → ⭐ `techniques/00-foveated-rendering-01-logpolar-mapping-2025-01-30.md`
- "Biological foundations of foveation?" → ⭐ `techniques/00-foveated-rendering-02-biological-foundations-2025-01-30.md`
- "Cortical magnification in V1?" → ⭐ `techniques/00-foveated-rendering-02-biological-foundations-2025-01-30.md`
- "Foveated vision transformers?" → ⭐ `techniques/00-foveated-rendering-01-logpolar-mapping-2025-01-30.md`
- "What is peripheral degradation?" → `techniques/01-peripheral-degradation.md`
- "How to combine LOD with culling?" → `techniques/02-occlusion-culling.md`
- "Explain progressive buffers" → `techniques/03-progressive-buffers.md`

**Algorithm Questions:**
- "How to build a BSP tree?" → `algorithms/00-bsp-construction.md`
- "How to select LOD levels?" → `algorithms/01-lod-selection.md`
- "How is terrain synthesized?" → `algorithms/02-terrain-synthesis.md`
- "Personalized LOD strategies?" → `algorithms/04-personalized-lod.md`

**Application Questions:**
- "LOD in video games?" → `applications/00-video-games.md`
- "LOD for VR/AR?" → `applications/01-vr-ar.md`
- "Terrain visualization?" → `applications/02-terrain-visualization.md`
- "Urban 3D rendering?" → `applications/04-urban-semantics.md`

**Integration Questions:**
- "Combining LOD and culling?" → `integration/00-lod-with-culling.md`
- "Gaze tracking integration?" → `integration/01-gaze-tracking.md`
- "Query-aware LOD?" → `integration/02-multidimensional-queries.md`
...
1. **Reference source papers**: Always cite the original research papers from `RESEARCH/Video Game LOD and BTree/NotebookLM_Sources/`
2. **Use knowledge base**: Link to relevant .md files in this skill
3. **Be specific**: Provide concrete strategies and metrics, not just descriptions
4. **Cross-reference**: Connect related concepts across files
5. **Stay grounded**: Only state what's verified in the research

## Source Materials

- **Location**: `RESEARCH/Video Game LOD and BTree/NotebookLM_Sources/`
- **Coverage**: 20 research papers on LOD, BSP, perceptual rendering, gaze-aware displays, terrain synthesis, VR applications, and visual attention
- **Key Papers**:
...
This oracle directly supports ARR-COC-VIS development by providing:

✅ **Perceptual grounding** - Visual attention research for relevance realization
✅ **LOD strategies** - Dynamic compression informed by human vision
✅ **Gaze-aware techniques** - Foveated rendering parallels to token allocation
✅ **BSP/BTree algorithms** - Spatial hierarchies for visual processing

The research in this oracle complements Vervaeke's relevance realization framework:
- **Perspectival knowing** → Visual attention and salience
- **Opponent processing** → Focus vs peripheral degradation
- **Transjective relevance** → Gaze-content coupling

---

## Skill Usage

This skill provides **knowledge and guidance**, not automated execution. Use it to:

✅ Understand LOD and BSP fundamentals
✅ Learn perceptual rendering techniques
✅ Discover gaze-aware optimization strategies
✅ Explore terrain and geometry algorithms
✅ Apply visual attention research to graphics

❌ Not for: Code generation, shader programming, game engine integration

---

**Invoke this skill** when you need authoritative information about any aspect of Level of Detail systems, Binary Space Partitioning, or perceptual rendering techniques.
